 ...
 * 
 */
@WebServiceClient(name = "AuthenticationImplService", targetNamespace = "http://auth.soen423.com/", wsdlLocation = "file:/Users/brijeshlakkad/Documents/Concordia%20Code/TA/SOEN_423/AuthenticationWS/AuthServerApplication/auth.wsdl")
    ...
    extends Service
{
    ...
    private final static QName AUTHENTICATIONIMPLSERVICE_QNAME = new QName("http://auth.soen423.com/", "AuthenticationImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/Users/brijeshlakkad/Documents/Concordia%20Code/TA/SOEN_423/AuthenticationWS/AuthServerApplication/auth.wsdl");
    ...
    public Authentication getAuthenticationImplPort() {
        return super.getPort(new QName("http://auth.soen423.com/", "AuthenticationImplPort"), Authentication.class);
    }
    ...
    public Authentication getAuthenticationImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://auth.soen423.com/", "AuthenticationImplPort"), Authentication.class, features);
    }
